...
pub use tauri::{
    ...
    hide_capture_window, is_capture_presentation_active, open_capture_window_for_session,
    prepare_capture_window_for_reveal, prewarm_capture_window, restore_capture_snapshot_windows,
