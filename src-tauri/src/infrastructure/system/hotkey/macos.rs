...
/// macOS hotkey backend (placeholder implementation)
...
impl HotkeyBackend for MacOSHotkeyBackend {
    async fn register(&self, accelerator: &str) -> Result<HotkeyId, AppError> {
        ...
        *next_id += 1;
        ...
        // TODO: Actual macOS hotkey registration in Phase 4
        // Will use Carbon or Cocoa APIs via core-foundation-rs or objc2
    ...
    async fn unregister(&self, id: HotkeyId) -> Result<(), AppError> {
        ...
        if registrations.remove(&id.0).is_some() {
            // TODO: Actual macOS hotkey unregistration in Phase 4
