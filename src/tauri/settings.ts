...
export async function getSettingsSnapshot() {
  return normalizeSnapshot(await invoke<BackendSettingsSnapshot>('get_settings_snapshot'));
}
...
export async function updateTranslationSettings(input: TranslationSettingsInput) {
  return normalizeSnapshot(
