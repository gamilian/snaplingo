...
vi.mock('../runtimeContext', () => ({
  useSettingsRuntime: () => ({
    providers: {
      listAnthropicModels: ({ endpoint, apiKey }: { endpoint: string; apiKey: string }) =>
        providerApi.listAnthropicModels({ endpoint, api_key: apiKey }),
      listGeminiModels: ({ endpoint, apiKey }: { endpoint: string; apiKey: string }) =>
        providerApi.listGeminiModels({ endpoint, api_key: apiKey }),
      listOpenAICompatibleModels: ({ endpoint, apiKey }: { endpoint: string; apiKey: string }) =>
        providerApi.listOpenAICompatibleModels({ endpoint, api_key: apiKey }),
      listTranslationPromptStrategies: providerApi.listTranslationPromptStrategies,
      saveTranslationPromptStrategies: providerApi.saveTranslationPromptStrategies,
      testAnthropic: providerApi.testAnthropicProvider,
      testGemini: providerApi.testGeminiProvider,
      testOpenAICompatible: providerApi.testOpenAICompatibleProvider,
      testOpenAIResponses: providerApi.testOpenAIResponsesProvider,
    },
  }),
}));
