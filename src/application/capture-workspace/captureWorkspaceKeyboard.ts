import type { CaptureWorkspaceKeyboardEvent } from './captureWorkspaceRuntimeTypes';
import {
...
import type { AnnotationCommand, ArrowKey, LogicalRect, Point } from '../../domain/capture';
...
export function handleCaptureWorkspaceEditorKeyDown(
  event: CaptureWorkspaceKeyboardEvent,
